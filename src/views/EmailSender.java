...
import coding.ConfigUtility;
import coding.EmailUtility;
import coding.JFilePicker;
import coding.SettingsDialog;
	...
	private void setupMenu() {
		menuItemSetting.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				SettingsDialog dialog = new SettingsDialog(EmailSender.this, configUtil);
